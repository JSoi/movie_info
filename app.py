...
# mongodb+srv://test:sparta@cluster0.q4meh.mongodb.net/cluster0?retryWrites=true&w=majority
client = MongoClient('mongodb+srv://test:sparta@cluster0.q4meh.mongodb.net/cluster0?retryWrites=true&w=majority',tlsCAFile=ca)
db = client.dbsparta
app = Flask(__name__)
